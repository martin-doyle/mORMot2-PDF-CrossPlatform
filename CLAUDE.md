...
- **Font subsetting**: opt-in via `TPdfDocument.EmbeddedWholeTtf := False`; unreliable for RTL/Arabic (GSUB glyph IDs not tracked); unsafe for CJK — see `.claude/skills/fonts.md` §9–10

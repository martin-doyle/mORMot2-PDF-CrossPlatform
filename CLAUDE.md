...
tests/
  test_runner.lpr              runs every suite below (green: 235 assertions on Windows with FPC, 125 with Delphi 7 — layer 1 suites only; 288 on macOS and 268 on Linux before R-21, 294 and 274 expected — the rest are skips)
